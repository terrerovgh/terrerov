 ...
 *
 * One wheel gesture is one stage. That is not arranged here — the page puts a
 * scroll-snap point at every `progressForStage`, so the scroll comes to rest
 * with the walker parked and his text finished, never mid-stride. Nor does this
 * file decide how fast any of it plays: the scroll only says where he should be,
 * and main.js walks him there at a pace the legs can sell.
 */
...
const DWELL_SCREENS = 0.5;
const TRAVEL_SCREENS = 0.6;
